...
final public class KBTabBarController: UITabBarController {
    ...
    public func addTab(tabRootController: KBBaseNavigationViewController, title: String, image: UIImage) {
