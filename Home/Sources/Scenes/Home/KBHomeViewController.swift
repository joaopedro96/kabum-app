...
public protocol KBHomeViewControllerDelegate: AnyObject {
    func goToProductDetailsPage(from tabIndex: Int, with url: String)
}

final public class KBHomeViewController: KBBaseNavigationViewController {
    ...
    public weak var delegate: KBHomeViewControllerDelegate?
...
extension KBHomeViewController: KBHomeViewDelegate {
    public func getNextProductList(for currentPage: Int) {
    ...
    public func didTapFavoriteButton(with state: Bool, and index: Int) {
